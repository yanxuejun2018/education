...
class Rotation extends Component {
    render() {
        console.log(this.props.SowData);
                ...
                <div className="container-fluid">
                    <div className="body advert">
                        ...
                        <div className="page-title">
                            <Link to="/sowingAdd" className="btn btn-danger btn-sm pull-right">添加轮播图</Link>
                        </div>
                                    ...
                                    SowData.map((item,index)=>{
                                        return(
                                            <tr>
                                                ...
                                                <td><img src={IMG_PRE+item.image_url} alt="" style={{width: 150}} /></td>
                                                <td><img src={IMG_PRE+item.image_small_url} alt="" style={{width: 150}} /></td>
                                                ...
                                                <td><Link   to={{
                                                    ...
                                                    <button onClick={()=>this._removeSwoing(item._id)} className="btn btn-danger btn-xs">删除</button></td>
                                            </tr>
                                        )
